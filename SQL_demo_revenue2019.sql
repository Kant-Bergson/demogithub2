-- chọn tất cả các cột từ bảng total_sale_2019 
select * from total_sale_2019;

-- chọn tất cả cã giá trị tại cột Product có dòng là iPhone
select * from total_sale_2019 where Product = "iPhone";
